...
public class UpdateAppService {
    ...
    private static void downloadUpdateToApkFile(DownloadCallback downloadCallback,
                                                URL url,
                                                File apkFile,
                                                long lenghtOfFile) throws IOException {
    ...
    private static long getLenghtOfFile(URL url) throws IOException {
    ...
    @NonNull
    private ResponseAPIGetDownloadAppUrl getGetDownloadAppUrl() throws StickerException {
